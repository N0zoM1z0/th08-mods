...
int main()
{
    ...
    ThModDifficultyStateV1 difficulty;
    if (th_mod_get_difficulty_state_v1(&difficulty) != TH_MOD_RESULT_OK ||
        difficulty.struct_size != sizeof(difficulty) ||
        difficulty.is_active != 1 ||
        difficulty.projectile_speed_numerator != 23 ||
        difficulty.projectile_speed_denominator != 20)
    {
        return 14;
    }
