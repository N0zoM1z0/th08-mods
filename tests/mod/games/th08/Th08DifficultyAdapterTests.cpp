...
void TestTh08DifficultyAdapter()
{
    ...
    CheckNear(th_mod::th08::ScaleProjectileSpeed(4.0f), 4.0f);
    ...
    CheckNear(th_mod::th08::ScaleProjectileSpeed(4.0f), 4.6f);
    ...
    CheckNear(th_mod::th08::ScalePlayerSpeed(4.0f), 4.0f);
    CheckNear(th_mod::th08::ScaleProjectileSpeed(4.0f), 3.4f);
